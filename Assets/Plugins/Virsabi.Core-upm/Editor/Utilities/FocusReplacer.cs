...
{
    static float defaultExtent = 0.1f; // if no renderer or collider is found, zoom to an object of this size
    static float maxExtent = 20f; // controls the maximum "zoom-out" when focusing large objects
    static float zoomFactor = 0.1f; // zoom-in more than Unity would by default (1f)
