...
/// How To Use:
/// 
/// 1. Make a scene for baking prefabs - set up the light settings and do bakes on the prefab until satisfied.
/// 
/// 2. Add this component to the root of the Prefab, then go to Assets -> Bake Prefab Lightmaps.
/// 
/// 3. ???
/// 
/// 4. PROFIT!
